...
export var cbse:Class[] = [
    ...
    {
        grade: 5,
        description: "Embark on a thrilling journey through Maths and Science, aligned with the CBSE curriculum for Class 5. Our program combines interactive lessons, hands-on experiments, and captivating activities to make learning an adventure. Develop a strong foundation and excel in these subjects with confidence and curiosity. Our engaging approach, backed by experienced educators, ensures a comprehensive understanding of key concepts, fostering a love for learning from an early age. Join us to unleash your child's potential and ignite a lifelong passion for Maths and Science.",
    },
